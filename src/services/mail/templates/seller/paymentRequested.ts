import { PaymentRequestedMailData } from '../../mailEvents';
import { createLayout } from '../layout';
import { PRIMARY_BUTTON_STYLE } from '../../../../utils/mailTemplate';

export const paymentRequestedTemplate = (data: PaymentRequestedMailData): string => {
  ...
  return createLayout(`
    ...
    <a href="https://mahallem.live/seller/payments" style="${PRIMARY_BUTTON_STYLE}">Ödeme Geçmişini Gör</a>
  `);
};
