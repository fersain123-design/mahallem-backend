...
const MARKET_MANAV_STORE_CATEGORIES: StoreCategory[] = [
...
const FIRIN_STORE_CATEGORIES: StoreCategory[] = [
...
const PASTANE_STORE_CATEGORIES: StoreCategory[] = [
...
const FIRIN_PASTANE_STORE_CATEGORIES: StoreCategory[] = [
  ...FIRIN_STORE_CATEGORIES,
  ...PASTANE_STORE_CATEGORIES,
];

const KASAP_STORE_CATEGORIES: StoreCategory[] = [
...
const SARKUTERI_STORE_CATEGORIES: StoreCategory[] = [
...
const KASAP_SARKUTERI_STORE_CATEGORIES: StoreCategory[] = [
  ...KASAP_STORE_CATEGORIES,
  ...SARKUTERI_STORE_CATEGORIES,
];

export const STORE_CATEGORIES: Record<StoreTypeKey, StoreCategory[]> = {
...
export const STORE_TYPE_ALIASES: Record<string, StoreTypeKey> = {
...
export const normalizeStoreType = (storeType?: string | null): StoreTypeKey => {
  const normalized = normalizeLookupKey(String(storeType || ''));
  return STORE_TYPE_ALIASES[normalized] || 'diger';
};

export const isVendorManagedStoreType = (storeType?: string | null) => normalizeStoreType(storeType) === 'diger';

export const getCategoriesByStoreType = (storeType?: string | null): StoreCategory[] => {
  const normalizedType = normalizeStoreType(storeType);
  return STORE_CATEGORIES[normalizedType].map((category) => ({ ...category }));
};