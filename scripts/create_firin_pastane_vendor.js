...
const DEMO_VENDORS = [
  {
    businessType: 'firin',
    categorySlug: 'firin',
    email: 'firin-sample@demo.com',
    phone: '5558100003',
    name: 'Demo Firin Satici',
    shopName: 'Demo Firin Ornek',
    iban: 'TR000000000000000000001003',
    bankName: 'Demo Bank',
  },
  {
    businessType: 'pastane',
    categorySlug: 'pastane',
    email: 'pastane-sample@demo.com',
    phone: '5558100004',
    name: 'Demo Pastane Satici',
    shopName: 'Demo Pastane Ornek',
    iban: 'TR000000000000000000001004',
    bankName: 'Demo Bank',
  },
];
  ...
  if (!vendorCategory) {
    vendorCategory = await prisma.category.create({
      data: {
        ...
        image: baseCategory.image || 'firin.webp',
...
main()
  .catch((error) => {
    console.error('CREATE_FIRIN_PASTANE_DEMO_VENDORS_FAILED');
