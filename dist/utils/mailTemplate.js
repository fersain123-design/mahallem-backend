...
exports.buildMahallemFromAddress = exports.buildMailTemplate = exports.PRIMARY_BUTTON_STYLE = void 0;
const DEFAULT_TITLE = 'Mahallem';
const DEFAULT_PREHEADER = 'Mahallem, mahalle esnafini musterilerle guvenli ve surdurulebilir sekilde bulusturan yerel ticaret platformudur.';
exports.PRIMARY_BUTTON_STYLE = 'background:#f59e0b;background-image:linear-gradient(90deg,#f59e0b 0%,#0a5c36 100%);color:#ffffff;padding:12px 20px;border-radius:8px;text-decoration:none;display:inline-block;font-size:14px;font-weight:700;';
const buildMailTemplate = ({ content, title = DEFAULT_TITLE, preheader = DEFAULT_PREHEADER, }) => {
    return `
    <!doctype html>
    <html lang="tr">
      <head>
...
const buildMahallemFromAddress = (rawSender) => {
...
exports.buildMahallemFromAddress = buildMahallemFromAddress;
