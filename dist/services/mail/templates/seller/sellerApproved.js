...
exports.sellerApprovedTemplate = void 0;
const layout_1 = require("../layout");
const mailTemplate_1 = require("../../../../utils/mailTemplate");
const sellerApprovedTemplate = (data) => {
    ...
    <a href="https://mahallem.live/seller" style="${mailTemplate_1.PRIMARY_BUTTON_STYLE}">Paneline Git</a>
...
exports.sellerApprovedTemplate = sellerApprovedTemplate;
