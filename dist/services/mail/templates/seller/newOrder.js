...
exports.newOrderTemplate = void 0;
const layout_1 = require("../layout");
const mailTemplate_1 = require("../../../../utils/mailTemplate");
const newOrderTemplate = (data) => {
    ...
    const itemRows = items
        ...
        const subtotal = Number(typeof item.subtotal === 'number' ? item.subtotal : unitPrice * quantity);
        return `
        <tr>
  ...
  `;
    ...
    ${summaryBlock}
    <a href="https://mahallem.live/seller/orders" style="${mailTemplate_1.PRIMARY_BUTTON_STYLE}">Siparişi Gör</a>
    <p style="margin:14px 0 0 0;font-size:14px;color:#444;">Bu sipariş, mahalle ekonomisine katkının yeni bir adımı.</p>
  `);
};
exports.newOrderTemplate = newOrderTemplate;
