...
exports.welcomeCustomerTemplate = void 0;
const layout_1 = require("../layout");
const mailTemplate_1 = require("../../../../utils/mailTemplate");
const welcomeCustomerTemplate = (data) => {
    ...
    <a href="https://mahallem.live" style="${mailTemplate_1.PRIMARY_BUTTON_STYLE}">Alışverişe Başla</a>
    <p style="margin:14px 0 0 0;font-size:14px;color:#444;">Birlikte, güvenli alışveriş kültürünü mahalle mahalle büyütüyoruz.</p>
  `);
};
exports.welcomeCustomerTemplate = welcomeCustomerTemplate;
