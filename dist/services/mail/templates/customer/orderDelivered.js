...
exports.orderDeliveredTemplate = void 0;
const layout_1 = require("../layout");
const mailTemplate_1 = require("../../../../utils/mailTemplate");
const orderDeliveredTemplate = (data) => {
    ...
    <a href="https://mahallem.live/orders" style="${mailTemplate_1.PRIMARY_BUTTON_STYLE}">Siparişlerini Gör</a>
